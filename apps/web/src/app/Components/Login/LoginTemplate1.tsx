  ...
  return (
    <div className="min-h-screen flex flex-col-reverse lg:flex-row items-center justify-between ">
      {view == "login" ? (
          ...
          <div className=" md:w-[80%] lg:w-[70%]">
            ...
            <form className="space-y-6 my-8">
              ...
              <div className="flex items-center">
                ...
                <span
                  onClick={() => setView("emailPass")}
                  className="mx-2 text-[#9D88B2] cursor-pointer"
                >
                  {" "}
                  / Password
                </span>
        ...
        <OtpScreenTemplate1 view={view} setView={setView} />
      ) : view == "emailPass" ? (
        <EmailPassTemplateScreen1 view={view} setView={setView} />
      ) : (
        <SignupTemplate1 view={view} setView={setView} />
      )}
